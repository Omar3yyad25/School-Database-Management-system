...
<link rel="stylesheet" href="Admission-portal.css" media="screen">
        ...
        <div class="u-expanded-width u-tab-links-align-left u-tabs u-tabs-1">
          <ul class="u-border-2 u-border-palette-1-base u-spacing-10 u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">Add student</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">Assign parent</a>
            </li>
          </ul>
                    ...
                    <div class="u-form-group u-form-partition-factor-2 u-form-select u-form-group-6">
                      ...
                      <div class="u-form-select-wrapper">
                        <select id="select-311e" name="PID" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                          <?php
                            $sql = "SELECT Parent_Code , First_Name FROM parent";
