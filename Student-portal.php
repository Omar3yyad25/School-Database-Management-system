...
$sql = "SELECT * FROM authentication_profile_system, student WHERE student.ID = authentication_profile_system.ID AND student.ID IN (SELECT ID from student WHERE First_Name = '$pieces[1]' AND Last_Name = '$pieces[2]')";
...
<link rel="stylesheet" href="Student-portal.css" media="screen">
  ...
  <body class="u-body u-overlap u-xl-mode"><header class="u-clearfix u-grey-80 u-header u-sticky u-sticky-cf2b u-header" id="sec-9c34"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-973e">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h4 class="u-text u-text-default u-text-1">Hello <?php echo $result['First_Name'] ?>,</h4>
        <div class="u-align-center u-tab-links-align-left u-tabs u-tabs-1">
          <ul class="u-border-9 u-border-palette-1-base u-spacing-10 u-tab-list u-unstyled" role="tablist">
            ...
            <li class="u-tab-item" role="presentation">
              <a class="u-active-palette-1-base u-button-style u-grey-10 u-tab-link u-text-active-white u-text-black u-tab-link-3" id="link-tab-2917" href="#tab-2917" role="tab" aria-controls="tab-2917" aria-selected="false">Fees</a>
            </li>
          </ul>
                ...
                <div class="u-expanded-width u-table u-table-responsive u-table-1">
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-alt-grey-5 u-table-body">
                      ...
                      <?php 
                      $sql2 = "SELECT * FROM grades WHERE studentid IN(SELECT ID from student WHERE First_Name = '$pieces[1]' AND Last_Name = '$pieces[2]')";
                  ...
                  <table class="u-table-entity">
                    ...
                    <tbody class="u-table-body">
                      <?php
                        ...
                        $sql3 = "SELECT datee , amount, Paid FROM tuition_fees WHERE Student_ID IN (SELECT ID from student WHERE First_Name = '$pieces[1]' AND Last_Name = '$pieces[2]')";
